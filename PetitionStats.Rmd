...
plot(Bracknell~time,data=bdf, type='l', main='~3400 Fake Signatures in Bracknell')
lines(Bracknell.pred~time, data=bdf, col='red', lwd=2)
legend(min(bdf$time),max(bdf$Bracknell)*0.9, legend=c('predicted','observed'), col=c('red','black'), lty=1, bty='n')
```
